 ...
 * Table of contents: 
 * main.js
 * Generated by MagicMin: 2020-10-10 01:03:42
 */
...
if(cargarPlugin('owlCarousel')){cargarRecursos([{tipo:'css',src:'js/jquery.owl-carousel/assets/owl.carousel.min.css'},{tipo:'css',src:'js/jquery.owl-carousel/assets/animate.min.css'},{tipo:'js',src:'js/jquery.owl-carousel/owl.carousel.min.js'},],function(){$('.slider-clientes > ul').owlCarousel({items:4,loop:true,autoplay:true,autoplayTimeout:4500,slideSpeed:100,nav:false,dots:true,responsive:{0:{items:2},550:{items:3},991:{items:4},},});$('.slider-casosTop > ul').owlCarousel({items:4,loop:true,autoplay:false,autoplayTimeout:4500,slideSpeed:100,nav:true,dots:false,navText:["<i class=\"icon-left-open icon\"></i><span></span>","<i class=\"icon-right icon\"></i><span></span>"],responsive:{0:{items:2},640:{items:3},991:{items:4},},});$('.slider-casosDown > ul').owlCarousel({items:4,loop:true,autoplay:false,autoplayTimeout:4500,slideSpeed:100,nav:true,dots:false,navText:["<i class=\"icon-left-open icon\"></i><span></span>","<i class=\"icon-right icon\"></i><span></span>"],responsive:{0:{items:2},640:{items:3},991:{items:4},},});});}
...
$(function(){$('html').addClass('active');$('a[href]').each(function(){if(location.hostname===this.hostname||!this.hostname.length){var link=$(this).attr("href");if(link.match("^#")){$(this).click(function(){var target=$(link);target=target.length?target:$('[name='+this.hash.slice(1)+']');if(target.length){$('html,body').animate({scrollTop:target.offset().top-70},1000);return false;}});}else if(link.match("^mailto")){}else{$(this).click(function(e){e.preventDefault();$('html').removeClass('active');setTimeout(function(){window.location=link;},500);});}}});});$(window).scroll(function(){var $cabecera=$('.cabecera');if($(window).scrollTop()>20){$('.logo').addClass('scroll');}else{$('.logo').removeClass('scroll');}});var $cabecera=$('.cabecera');var previousScroll=0;$(window).scroll(function(event){var scroll=$(this).scrollTop();if(scroll>previousScroll&&scroll>400){$cabecera.addClass('ocultar');$(".navbar-collapse").removeClass("in").addClass("collapse");$(".hamburger").removeClass("is-active");$("nav").removeClass("activo");}else{$cabecera.removeClass('ocultar');}
previousScroll=scroll;});$(document).ready(function(){$('.hamburger').click(function(){$(this).toggleClass('clickeado');$('nav').toggleClass('activo');});});$(document).ready(function(){$('.franja').mouseover(function(){$(this).addClass('oculto');})
$('.franja').mouseleave(function(){$(this).removeClass('oculto');})});function cargarPlugin(plugin){return(window.jsplugins.indexOf(plugin)!==-1);}
